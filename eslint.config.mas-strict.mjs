...
const readabilityRules = {
  ...
  "id-length": [
    "error",
    { min: MIN_IDENTIFIER_LENGTH, exceptions: IDENTIFIER_EXCEPTIONS, properties: "never" },
  ],
  "no-magic-numbers": [
    "warn",
    {
  ...
  "no-restricted-syntax": [
    "error",
    {
      ...
      message: "Dziedziczenie tylko po Error (pg/paradigm.md: kompozycja > dziedziczenie).",
    },
    {
      selector: "TSEnumDeclaration",
      message: 'Uzyj unii literalow (`type X = "a" | "b"`) zamiast enum.',
    },
  ],
};
