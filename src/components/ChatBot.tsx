...
const COPY: Record<Lang, Copy> = {
  en: {
    ...
    starters: ['Is he a fit for my role?', 'What has he actually shipped?', 'What are his strengths and weaknesses?', '🎤 Interview me about him'],
  ...
  pl: {
    ...
    starters: ['Czy pasuje do mojej roli?', 'Co realnie zbudował?', 'Jakie ma mocne i słabe strony?', '🎤 Przepytaj mnie o Kamila'],
