...
export const T: Record<Lang, SiteTranslation> = {
  en: {
    hero: {
      ...
      h1b: "Less",
      h1em: "manual work.",
      sub: "I build systems that work instead of your team. Then I train them to run it.",
    ...
    beyond: {
      ...
      short: "Short version: 99 pages, about an hour",
      full: "Complete guidebook: 199 pages",
  ...
  pl: {
    hero: {
      ...
      h1b: "Mniej",
      h1em: "ręcznej pracy.",
      sub: "Buduję systemy, które pracują za Twój zespół. Potem uczę go z nich korzystać.",
    ...
    beyond: {
      ...
      short: "Wersja skrócona: 99 stron, około godziny",
      full: "Pełny przewodnik: 199 stron",
