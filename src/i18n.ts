...
export const T: Record<Lang, SiteTranslation> = {
  en: {
    ...
    hero: {
      ...
      h1b: 'that run',
      h1em: 'themselves.',
      sub: "I don't just plan — I write the code, run the ads, build the automations, and lead the team. Solo founders and companies hire me when they need someone who can actually do all of it.",
      cta: 'Work with me',
      ctaGhost: 'See my work',
    },
    stats: ['Businesses built', 'Active verticals', 'Years operating', 'Countries'],
    about: {
      label: 'About',
  ...
  pl: {
    ...
    hero: {
      ...
      h1b: 'które działają',
      h1em: 'same.',
      sub: 'Nie tylko planuję — piszę kod, prowadzę reklamy, buduję automatyzacje i zarządzam zespołem. Solo-founderzy i firmy współpracują ze mną, gdy potrzebują kogoś kto faktycznie to wszystko potrafi.',
      cta: 'Współpracujmy',
      ctaGhost: 'Moje projekty',
    },
    stats: ['Zbudowanych biznesów', 'Aktywnych pionów', 'Lat doświadczenia', 'Krajów'],
    about: {
      label: 'O mnie',
