...
export const T: Record<Lang, SiteTranslation> = {
  en: {
    ...
    about: {
      ...
      p1e: ". Most coaches can't build and most builders can't teach; I do both.",
  ...
  pl: {
    ...
    about: {
      ...
      p1e: '. Większość coachów nie umie budować, większość builderów nie umie uczyć; ja robię jedno i drugie.',
