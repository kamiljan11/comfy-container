...
export const SEQUENCES: Record<string, WelcomeSequence> = {
  "dmt-subscriber": {
    ...
    emails: [
      {
        systemeStepId: 3506672,
        delayDays: 0,
        subject: "Ready for DMT? ✅✅✅",
        body: "TODO: paste body from Systeme.io email 12418779",
      },
      {
        systemeStepId: 3506673,
        delayDays: 2,
        subject: "Benefits of DMT 💎💎💎",
        body: "TODO: paste body from Systeme.io email 12418783",
      },
      {
        systemeStepId: 3506674,
        delayDays: 3,
        subject: "Let's Connect and Share 🙏🙏🙏",
        body: "TODO: paste body from Systeme.io email 12418788",
      },
      {
        systemeStepId: 3506675,
        delayDays: 3,
        subject: "Beyond the Session 🧩🧩🧩",
        body: "TODO: paste body from Systeme.io email 12418790",
      },
      {
        systemeStepId: 3512337,
        delayDays: 3,
        subject: "Vision for My Spirit Way—The Journey Ahead 🚀🚀🚀",
        body: "TODO: paste body from Systeme.io email 12418792",
      },
      {
        systemeStepId: 3506677,
        delayDays: 3,
        subject: "Ways You Can HELP ❤️❤️❤️",
        body: "TODO: paste body from Systeme.io email 12418792",
      },
    ],
  },
  "iyss-subscriber": {
    ...
    emails: [
      ...
      {
        delayDays: 3,
        subject: "Benefits of the Integration Session ✅✅✅",
        body: "TODO: paste body",
      },
      ...
      {
        delayDays: 3,
        subject: "My Biggest Dreams - MySpiritWay Vision 🚀🚀🚀",
        body: "TODO: paste body",
      },
  ...
  "sps-subscriber": {
    ...
    emails: [
      ...
      {
        delayDays: 3,
        subject: "(4) SBNR? (Spiritual But Not Religious)",
        body: "TODO: paste body",
      },
      ...
      {
        delayDays: 3,
        subject: "(6) Cosmetics and Cleaning Products - what to be aware of",
        body: "TODO: paste body",
      },
  ...
  "spiritual-marketing-subscriber": {
    ...
    emails: [
      ...
      {
        delayDays: 2,
        subject: "Is it really spiritual to charge for your work? 💸✨",
        body: "TODO: paste body",
      },
      {
        delayDays: 3,
        subject: "How to price spiritual work without guilt? 😬",
        body: "TODO: paste body",
      },
      { delayDays: 3, subject: "Your business is not a machine 🫀", body: "TODO: paste body" },
      {
        delayDays: 3,
        subject: "7 gears that turn your spiritual work into stable income ⚙️❤️‍🔥",
        body: "TODO: paste body",
      },
      {
        delayDays: 3,
        subject: "How to get clients as a spiritual coach (even with a tiny audience) 🔍",
        body: "TODO: paste body",
      },
    ],
  },
  "awakening-circle": {
    ...
    emails: [
      {
        delayDays: 0,
        subject: "You are about to dive Deeply Into Spirituality",
        body: "TODO: paste body — single-email broadcast in original campaign.",
      },
    ],
  },
};
