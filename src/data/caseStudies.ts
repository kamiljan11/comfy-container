...
export const FEATURED: CaseStudy[] = [
  ...
  },
  {
    ...
    resultsPreview:
      "A consumer parts-import channel needed quoting, invoices, SMS and shipping labels — and its only operator lives in Google Sheets. So the whole back office is a spreadsheet: an Apps Script system with a pricing sidebar, an accept-by-email flow, VAT invoices generated to Drive, and Twilio SMS. It has processed dozens of real orders since January. Total infrastructure cost: zero.",
    problem:
    ...
    results:
      "The consumer channel runs end to end — request, quote, acceptance, invoice, SMS, label — on infrastructure that costs nothing and lives entirely where its operator already works. Dozens of real orders since January. The operator prices and manages everything from the sheet without asking me to translate.\n\nAnd the part I find quietly satisfying: when something does look off, the fix is a person editing a cell, not a support ticket to me.",
    principle:
