  ...
  },
  {
    ...
    decisions: [
      ...
      },
      {
        ...
        rejected:
          "Relying on the pre-commit layer alone. It stays — it gives fast local feedback — but it's the seatbelt, not the wall.",
        tradeoff:
