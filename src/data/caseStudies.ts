...
export const FEATURED: CaseStudy[] = [
  ...
  },
  {
    ...
    decisions: [
      {
        ...
        why: "Thirty repos means any manual step happens thirty times, badly. A single command copies the workflow files, review config and docs scaffold into a repo and wires branch protection, so a new repo gets the full floor the minute it exists. The standard lives in one place and rolls forward from there.",
        rejected:
      ...
      {
        decision:
          "Give the weekly self-improvement loop a hard net-negative rule: its pull requests must remove more code than they add.",
    ...
    stack: [
      ...
      "Net-negative weekly auto-improve loop",
