    ...
    experience: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Ran digital marketing (Meta & Google Ads) and sales newsletters; did product development and on-glacier guiding. Helped grow it into a well-reviewed glacier-tour operator with more than 1,000 five-star guests.",
        ],
      },
      {
        role: "Owner",
      ...
      },
      {
        ...
        dates: "2015–2018",
        bullets: [
          "Led the foundation: social media and brand, HR, program development and public representation.",
        ],
      },
      {
  ...
  pl: {
    ...
    experience: [
      ...
      },
      {
        ...
        dates: "2015–2018",
        bullets: [
          "Kierował fundacją: social media i marka, HR, rozwój programów i reprezentacja publiczna.",
        ],
      },
      {
