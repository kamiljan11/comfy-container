...
const CONTENT: Record<Lang, CV> = {
  en: {
    ...
    education: [
      {
        label: 'Learned by building, not by studying.',
        body: 'Every technical skill here — full-stack engineering and applied AI — is self-taught, earned by shipping real products for real businesses. Treats production as the classroom: take on a problem worth solving, build the system, learn whatever the build demands.',
      },
      {
        label: 'General secondary education',
        body: '— science, economics & accounting. Rzeszów, Poland · 2013–2016.',
      },
      {
        label: 'Continuous learning:',
        body: 'ongoing AI & engineering courses and docs; trading (2019); 200-hour Yoga Teacher certification; Icelandic (levels 1–2).',
      },
    ],
    languages: [
  ...
  pl: {
    ...
    summary:
      ...
      'zespół, żeby prowadził to dalej, gdy odchodzi od biurka. „Większość coachów nie umie budować, większość ' +
      'builderów nie umie uczyć — ja robię jedno i drugie.” W dużej mierze samouk: inżynierii i AI nauczył się, ' +
      'wdrażając realne produkty, nie na wykładach. Wyszedł od sprzedaży i marketingu w Polsce (najlepszy sprzedawca; ' +
      'założył i prowadził agencję marketingową), po przeprowadzce na Islandię odbudował się od podstaw, a dziś buduje ' +
      'i prowadzi kilka biznesów od A do Z.',
    skills: [
      {
    ...
    experience: [
      {
        ...
        dates: '2021 — present',
        bullets: [
          'Zbudował i prowadzi platformę operacyjną B2B w pionach części samochodowych, druku i logistyki: 13-etapowy pipeline od oferty do zamówienia, wycena per pozycja, zarządzanie prowizjami i dostęp oparty na rolach — używana na żywo w terenie jako aplikacja mobilna.',
      ...
      },
      {
        ...
        dates: '2023 — present',
        bullets: [
          'Zbudował platformę SaaS: silnik cenowy na 10 rynkach z geolokalizacją, CRM od leada do umowy oraz generowanie PDF umów z VAT per kraj.',
      ...
      },
      {
        ...
        dates: '2023 — present',
        bullets: [
          'Zbudował marketplace zbiorowych zamówień i importu: grupowe kampanie kontenerowe z logiką depozytu/zwrotu, transgraniczna wycena importu z VAT i panel admina z przychodami na żywo.',
        ],
      },
      {
        role: 'Założyciel',
        ...
        dates: '2022 — present',
        bullets: [
          'Zbudował wielojęzyczną (EN / PL / IS) stronę marketingową i lejek leadów dla marki „złotej rączki” — pełna marka i flow sprzedaży dostarczone w 72 godziny.',
        ],
      },
      {
        role: 'Założyciel',
      ...
      },
      {
        ...
        dates: '2022 — 2024',
        bullets: [
          'Współbudował biznes turystyczny od A do Z: strona (Bokun), cennik, kanały sprzedaży, umowy z resellerami i partnerami oraz reprezentacja na targach.',
      ...
      },
      {
        ...
        dates: '2018 — present',
        bullets: [
          'Zbudował markę contentową i społeczność wokół praktycznego, sześcioletniego autorskiego przewodnika (dwie wydane książki, trzecia w toku); content multi-platformowy (YouTube, TikTok, Instagram, Facebook) i prowadzenie wydarzeń na żywo dla grup 100+.',
        ],
      },
      {
      ...
      {
        role: 'Wcześniejsze role — sprzedaż, marketing i operacje',
    ...
    education: [
      {
        label: 'Nauka przez budowanie, nie przez studiowanie.',
        body: 'Każda umiejętność techniczna tutaj — full-stack i applied AI — jest samodzielnie wyuczona, zdobyta przez wdrażanie realnych produktów dla realnych firm. Produkcja jest salą wykładową: weź problem wart rozwiązania, zbuduj system, naucz się tego, czego wymaga build.',
      },
      {
      ...
      {
        label: 'Ciągła nauka:',
        body: 'bieżące kursy i dokumentacja AI oraz inżynierii; trading (2019); certyfikat nauczyciela jogi (200h); islandzki (poziomy 1–2).',
      },
    ],
    languages: [
