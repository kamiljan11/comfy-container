...
const PERSON_SCHEMA = {
  ...
  "description": "Iceland-based entrepreneur, operator, and AI automation architect. Founder of MAS Group, Flyt, Reykjawwwik, QuickFix, and more. Available as co-founder, advisor, or senior hire.",
  "address": {
    "@type": "PostalAddress",
  ...
  "sameAs": [
    "https://github.com/mountainallservice",
    "https://linkedin.com/in/kamiljan"
  ],
  "worksFor": {
    "@type": "Organization",
    "name": "MAS Group"
...
const WEBSITE_SCHEMA = {
  ...
  "url": "https://kamiljan.com",
  "name": "Kamil Jan",
  "description": "Portfolio and contact page of Kamil Jan — entrepreneur, operator, and AI automation architect based in Reykjavík, Iceland."
};
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "Kamil Jan, entrepreneur Iceland, AI automation Reykjavik, systems builder, co-founder Iceland, startup operator, Head of Operations Iceland, MAS Group, Flyt Iceland" },
      // Open Graph
      ...
      { property: "og:description", content: "Reykjavík-based entrepreneur who builds and scales businesses. Available as co-founder, advisor, or senior hire. 5+ years building B2B operations in Iceland." },
      { property: "og:image", content: "https://kamiljan.com/og-image.png" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Kamil Jan — Entrepreneur & Systems Builder based in Reykjavík" },
      // Twitter / X
      ...
      { name: "twitter:image:alt", content: "Kamil Jan — Entrepreneur & Systems Builder" },
    ],
    links: [
