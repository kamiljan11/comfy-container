...
- [2026-09-21] Czerwony `Mutation` na PR, ktory zmienia glownie copy (slowniki tekstow, dane tresci, JSX/CSS) = swiadomie etykieta `allow-low-mutation`, nie bloker; recenzent nie zada testow na stringi, ale NOWA logika w tym PR (mapa po slugu, warunek, funkcja) nadal musi miec test (zrodlo: PR #37, #41, #42)
